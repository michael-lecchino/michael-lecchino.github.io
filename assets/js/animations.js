...
$(document).ready(function() {
  ...
  $(".project-wrapper").fadeIn(333);
  $("a").click(function(e) {
    redirect = $(this).attr("href");
    e.preventDefault();
    $(".project-wrapper").fadeOut(333, function() {
      document.location.href = redirect
    })
  })
});
...
$(document).ready(function() {
  ...
  $(".lock").click(function(e) {
    $(".lock-overlay").fadeIn(333);
    $(".main").addClass("shrink")
  });
  $(".lock-overlay").click(function(e) {
    $(".lock-overlay").fadeOut(333);
...
$(document).ready(function() {
  ...
  $('.contact, a[class^="item-"]:not(.lock)').click(function() {
    $("body").addClass("dark");
